/************************* Variables *************************************/
// At the top of the game.js file,
...
/**************** when any key is pressed by user ***********************/
...
$(".btn").on("click", function() {
  ...
  // index number starts from zero, that's why we will write length-1
...
function checkAnswer(currentLevel) {
  ...
  // gamePattern[] holds random chosen color
  // userClickedPattern[] holds id(color) of the button on which user clicked.
  if (gamePattern[currentLevel] === userClickedPattern[currentLevel]) {
    //console.log("success");

    console.log("userClickedPattern " + userClickedPattern)

    // If the user got the most recent answer right in the above if-else statement,
...
function nextSequence() {
  ...
  // Inside the nextSequence function generate a new random number between 0 and 3,
